...
class TaskBackend(ABC):
    ...
    @abstractmethod
    def get_target(self, batch) -> torch.Tensor:
        ...
    ...
    @abstractmethod
    def predict(self, output: torch.Tensor) -> np.ndarray:
        ...
...
def get_task_backend(task: str, **kwargs) -> TaskBackend:
    if task == "classification":
        ...
        raise ValueError(f"Unknown task: {task}. Supported: classification, regression, reconstruction")
