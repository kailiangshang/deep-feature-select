...
DEVICE = "cpu"
HIDDEN = 64
RESULTS_DIR = "exp/results/toy_demo"
...
def main():
    ...
    # ==================================================================
    print("\n" + "#" * 60)
    print("# CLASSIFICATION (ToyCls)")
    print("#" * 60)
    cls_data = generate_train_test_loader("ToyCls", batch_size=64, device=DEVICE, random_state=0)
    k_cls = 50
    ...
    # ==================================================================
    print("\n" + "#" * 60)
    print("# REGRESSION (ToyReg)")
    print("#" * 60)
    reg_data = generate_train_test_loader("ToyReg", batch_size=64, device=DEVICE, random_state=0)
    k_reg = 30
    ...
    # ==================================================================
    print("\n" + "#" * 60)
    print("# RECONSTRUCTION (ToyAE)")
    print("#" * 60)
    ae_data = generate_train_test_loader("ToyAE", batch_size=64, device=DEVICE, random_state=0)
    k_ae = 40
    ...
    # ==================================================================
    # ABLATION (sparse_loss_weight sweep)
    # ==================================================================
    print("\n" + "#" * 60)
